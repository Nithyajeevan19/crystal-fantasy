...
const items = [
  ...
  { title: "Royal Rajasthani Art", subtitle: "Paintings & Frames", img: painting, span: "" },
  { title: "Corporate Gifting", subtitle: "Curated Hampers", img: corp, span: "" },
  { title: "Modern Home Decor", subtitle: "Wall & Accent Pieces", img: wall, span: "lg:col-span-2" },
  { title: "Festive Decor", subtitle: "Diyas & Candles", img: candle, span: "" },
  { title: "Crystal Collection", subtitle: "Refined Sculptures", img: crystal, span: "" },
];
  ...
  return (
    <section id="collections" className="py-28 lg:py-40 bg-ivory">
      <div className="mx-auto max-w-7xl px-6 lg:px-10">
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 auto-rows-[280px] gap-5">
          {items.map((it, i) => (
            <motion.a
              href="#specialities"
              key={it.title}
            ...
            >
              ...
              <div className="absolute inset-x-0 bottom-0 p-7 transition-transform duration-500 group-hover:-translate-y-2">
                ...
                <div className="mt-4 inline-flex items-center gap-2 text-ivory/80 text-xs tracking-[0.25em] uppercase opacity-0 group-hover:opacity-100 transition-opacity duration-500">
